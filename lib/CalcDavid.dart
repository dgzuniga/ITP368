  ...
  Widget conversion(String label) {
    return Expanded(
      child: FloatingActionButton(
        ...
        mini: true,
        child: Text(label, style: const TextStyle(fontSize: 20)), // smaller floatingactionbutton
      ),
    );
  }
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Expanded(
                      child: FloatingActionButton(
                        onPressed: negativeSign,
                        mini: true, // Add negative sign when clicked
                ...
                Row(
                  children: [
                    Expanded(
                      child: FloatingActionButton(
                        onPressed: delete,
                        mini: true, // Delete last number from input
                    ...
                    Expanded(
                      child: FloatingActionButton(
                        onPressed: clear,
                        mini: true, // clear the input and output fields
