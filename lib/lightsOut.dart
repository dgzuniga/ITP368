        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration: const InputDecoration(labelText: 'Enter number of lights'),
            ),
            ...
            ElevatedButton(
              ...
              child: const Text('Generate Lights'),
            ),
            const SizedBox(height: 16),
            Expanded(
              child: BlocBuilder<LightsOutBloc, List<bool>>(
                builder: (context, lights) {
                  if (lights.isEmpty) return const Text('Enter a number and click Generate');
